 ...
 */
#ifndef _MESH_MP_PP_CONTROLLER_HPP_
#define _MESH_MP_PP_CONTROLLER_HPP_
...
public:
  ...
  AsyncMeshMpPpController &operator=(AsyncMeshMpPpController &&other) = delete;

  ~AsyncMeshMpPpController() override;
